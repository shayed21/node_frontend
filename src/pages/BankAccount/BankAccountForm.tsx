      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {isEdit ? 'Update bank account information' : 'Enter bank account details to add'}
          </p>
        </div>
      </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              />
              {errors.accountNo && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.accountNo.message}</p>
              )}
            </div>
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              />
              {errors.bankName && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.bankName.message}</p>
              )}
            </div>
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
              ...
              />
              {errors.branchName && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.branchName.message}</p>
              )}
            </div>
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">
