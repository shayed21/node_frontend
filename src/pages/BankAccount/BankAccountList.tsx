...
const deleteBankAccount = async (id: number) => {
  try {
    ...
    setBankAccount((prevBankAccount) => prevBankAccount.filter(( bankAc) => bankAc._id !== id));
  } catch (error) {
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage your bank account List</p>
        </div>
        </div>
        <button
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button
                        onClick={() => navigate(`/bankAccount/${bankAc?._id}/edit`)}
                        className="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button onClick={() => deleteBankAccount(bankAc?._id)} className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
