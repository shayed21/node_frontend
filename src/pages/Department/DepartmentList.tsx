    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Department</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage your department List</p>
        </div>
        </div>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button
                        onClick={() => navigate(`/department/${department?._id}/edit`)}
                        className="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button onClick={() => deleteDepartment(department?._id)} className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
