  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Expense</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage your expense List</p>
        </div>
        </div>
        <button
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button
                        onClick={() => navigate(`/expense/${expense?._id}/edit`)}
                        className="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300"
                      >
                        <Edit className="w-4 h-4" />
                      </button>
                      <button onClick={() => deleteExpense(expense?._id)} className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
