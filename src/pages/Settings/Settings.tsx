                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { key: 'salesNotifications', label: 'Sales Notifications', description: 'Receive updates on new sales' },
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <button className="flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                      <div>
                        <h4 className="font-medium text-gray-900 dark:text-white">Collapsed Sidebar</h4>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Keep the sidebar collapsed by default</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
