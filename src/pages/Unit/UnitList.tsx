    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Unit</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage your unit List</p>
        </div>
        </div>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button onClick={() => deleteUnit(unit?._id)} className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
