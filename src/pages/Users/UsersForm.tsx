...
const schema = yup.object({
  ...
  role: yup.string().oneOf(['admin', 'manager', 'cashier'], 'Invalid role').required('Role is required'),
...
export const UsersForm: React.FC = () => {
  ...
  const getRolePermissions = (role: string) => {
    switch (role) {
      case 'admin':
        return ['Full system access', 'User management', 'System settings', 'All reports', 'Data backup'];
      case 'manager':
        return ['Department management', 'Sales reports', 'Inventory management', 'Staff oversight'];
      case 'cashier':
        return ['Sales transactions', 'Customer service', 'Basic inventory view', 'Daily reports'];
      default:
        return [];
    }
  };
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {isEdit ? 'Update user information and permissions' : 'Create a new user account with appropriate access'}
          </p>
        </div>
      </motion.div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center space-x-6">
            <div className="relative">
              {avatarPreview || isEdit ? (
                <img
                  src={avatarPreview || 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face'}
                  alt="Avatar preview"
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6"
        >
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Employment Information</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Role *
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              {errors.emergencyContactName && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.emergencyContactName.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.emergencyContactPhone && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.emergencyContactPhone.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.emergencyContactRelation && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.emergencyContactRelation.message}</p>
              )}
            </div>
          </div>
        </motion.div>
